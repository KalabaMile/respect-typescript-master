...
const MaliRespektaši = ({ setSelectedPage }: Props) => {
    ...
    return (
        <div className="bg-hero bg-cover">
            <section id="malirespektaši" className="mx-auto sm:w-5/6 pt-10 sm:py-10 md:py-20">
                <motion.div
                    onViewportEnter={() => setSelectedPage(SelectedPage.MaliRespektaši)}
                >
                    <div className="justify-between md:flex">
                        <motion.div
                            className="md:flex flex-col justify-center mb-10 md:mb-0 mx-10 sm:mx-0 basis-2/6"
                            initial="hidden"
                            whileInView="visible"
