...
const Navbar = ({ isTopOfPage, selectedPage, setSelectedPage }: Props) => {
  ...
  const navbarBackground = isTopOfPage ? "" : "bg-hero2 bg-cover drop-shadow-lg";
          ...
          <div className={`${flexBetween} w-full gap-16`}>
            ...
            <div className="flex items-center sm:justify-end gap-10">
              ...
              >
                ...
                : <motion.button
                  className="rounded-full bg-red-600 p-2 hover:bg-primary-100 text-primary-500 hover:text-primary-500"
                  onClick={() => setIsMenuToggled(!isMenuToggled)}
                  whileHover={{ scale: 1.2 }}
                  whileTap={{ scale: 0.8 }}
                >
